...
const AboutUs = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-slate-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(194,178,128,0.03),transparent_50%)]"></div>
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-gradient-to-bl from-yellow-900/5 to-transparent rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-gradient-to-tr from-yellow-700/5 to-transparent rounded-full blur-3xl"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-2xl transform group-hover:scale-[1.02] transition-transform duration-500">
                ...
                <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-yellow-900 to-yellow-600 rounded-xl flex items-center justify-center">
                      <svg
          ...
          <div className="lg:w-1/2 space-y-8">
            <div className="space-y-6">
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-sm border border-gray-100/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                <p className="text-gray-700 leading-relaxed text-lg">
                  ...
                  and every family has different needs. That&apos;s why we offer
                  a comprehensive range of furniture including sofas, beds,
                  dining sets, wardrobes, curtains, blinds, and mattresses. Our
                  expert design team works closely with customers to create
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="px-8 py-4 bg-gradient-to-r from-yellow-900 to-yellow-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2">
              ...
              <button className="px-8 py-4 border-2 border-yellow-900 text-yellow-900 font-semibold rounded-2xl hover:bg-yellow-900 hover:text-white transition-all duration-300 flex items-center justify-center gap-2">
