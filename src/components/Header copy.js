          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4">
            ...
            <div className="flex flex-col xs:flex-row items-center justify-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center group">
                <FaPhone className="text-yellow-900 text-sm sm:text-base transition-transform group-hover:scale-110 mr-1 sm:mr-2" />
                <a
                  href="tel:+919054768724"
                  className="text-xs sm:text-sm group-hover:text-yellow-900 transition-colors whitespace-nowrap"
                >
                  +91 9054768724
                </a>
              </div>
              ...
              <div className="flex items-center group">
                <FaEnvelope className="text-yellow-900 text-sm sm:text-base transition-transform group-hover:scale-110 mr-1 sm:mr-2" />
                <a
                  href="mailto:kalikafurniture@gmail.com"
                  className="text-xs sm:text-sm group-hover:text-yellow-900 transition-colors break-all sm:break-normal"
                >
            ...
            <div className="flex flex-col xs:flex-row items-center flex-wrap justify-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center flex-wrap justify-center divide-x divide-neutral-600">
                <a
                  href="#"
                  className="px-2 sm:px-3 py-1 rounded hover:text-yellow-900 hover:bg-neutral-700/50 transition-all text-center whitespace-nowrap"
                >
                  Track Order
                </a>
                <a
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex flex-1 max-w-xl mx-8">
              ...
              >
                ...
                <button
                  type="submit"
                  className={`absolute right-3 top-1/2 transform -translate-y-1/2 bg-yellow-900 text-white p-2.5 rounded-full hover:bg-yellow-800 transition-all duration-300 flex items-center justify-center ${
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <div className="relative group">
                ...
                >
                  ...
                  <span className="text-xs mt-1 text-neutral-600 group-hover:text-yellow-900 transition-colors">
                    Wishlist
                  </span>
                </a>
              ...
              <div className="relative group">
                ...
                >
                  <FaUser className="text-2xl text-neutral-600 group-hover:text-yellow-900 transition-colors" />
                  <span className="text-xs mt-1 text-neutral-600 group-hover:text-yellow-900 transition-colors">
                    Account
                  </span>
                </a>
              ...
              <div className="relative group">
                ...
                >
                  <div className="relative">
                    <FaShoppingCart className="text-2xl text-neutral-600 group-hover:text-yellow-900 transition-colors" />
              ...
              <form onSubmit={handleSearch}>
                <div className="relative">
                  <input
                    ...
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="w-full px-4 py-3 pr-12 border-2 border-neutral-300 rounded-lg focus:ring-2 focus:ring-yellow-900 focus:border-transparent shadow-sm"
                  />
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-yellow-900 text-white p-2 rounded-md hover:bg-yellow-800 transition-colors"
                  >
                  ...
                  <li>
                    <Link
                      ...
                      className={`block px-5 py-4 text-sm font-semibold tracking-wide transition-colors duration-300 border-r border-gray-200/50
                        ${link.label === 'Premium Furniture' ? 'text-[#7a294a] font-bold hover:text-[#a13c6a]' : link.label === 'Mattress' ? 'text-blue-800 font-bold hover:text-blue-600' : 'text-neutral-800 hover:text-yellow-900'}
            ...
            <div className="p-6">
              ...
              >
                <div className="relative">
                  <input
                    ...
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="w-full px-4 py-3 pr-12 bg-white border border-neutral-200 rounded-lg focus:ring-2 focus:ring-yellow-900 focus:border-transparent"
                  />
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-yellow-900 text-white p-2 rounded-md hover:bg-yellow-800 transition-colors"
              ...
              <div className="mb-6">
                ...
                <div className="space-y-1">
                  ...
                  >
                    <FaUser className="mr-3 text-yellow-900" />
                  ...
                  <a
                    ...
                    className="block py-3 px-4 hover:bg-neutral-50 rounded-lg transition-colors flex items-center"
                  >
                    <FaShoppingCart className="mr-3 text-yellow-900" />
                    <span>My Cart (5)</span>
                  </a>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3 text-sm bg-neutral-50 p-4 rounded-lg">
                  <div className="flex items-center space-x-3">
                    <div className="bg-yellow-900/10 p-2 rounded-full">
